...
public class Block3 extends District3 {
	...
	public Block3(StringQuestion gov_name, double total_budget, double state_work_meney, StringQuestion state_name, StringQuestion gov_name2,
			double state_budget, StringQuestion gov_type, double district3_budget, StringQuestion blockname) {
